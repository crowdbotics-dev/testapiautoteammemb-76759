...
## Project Structure
    ...
    ├── testapiautoteammemb_76759  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_76759`
...
2. Clone this repo and `cd testapiautoteammemb_76759`
